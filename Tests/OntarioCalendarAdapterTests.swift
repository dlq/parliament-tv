...
final class OntarioCalendarAdapterTests: XCTestCase {
    func testMapsHouseAndCommitteeCalendarEventsToOntarioChannels() throws {
        ...
        let metadata = OntarioCalendarAdapter.programMetadataByChannelID(
            from: html,
            now: now,
        ...
        XCTAssertEqual(house.nextEventTitle, "Standing Committee on Finance and Economic Affairs - Room 151")
        ...
        XCTAssertEqual(room151.nextEventTitle, "Standing Committee on Finance and Economic Affairs - Room 151")
    }
