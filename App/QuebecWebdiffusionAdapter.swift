...
enum QuebecWebdiffusionAdapter {
    static let liveURL = URL(string: "https://www.assnat.qc.ca/Gabarits/RefonteVA_Accueil.aspx/ObtenirListeEnDirect")!
    static let upcomingURL = URL(string: "https://www.assnat.qc.ca/Gabarits/RefonteVA_Accueil.aspx/ObtenirListeAVenir")!
...
private extension String {
    nonisolated func cleanedHTML() -> String {
