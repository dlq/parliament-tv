...
#if os(iOS)
  extension View {
    fileprivate func channelSwipeNavigation(
...
extension View {
  fileprivate func remoteChannelNavigation(
    previous: @escaping () -> Void, next: @escaping () -> Void
  ) -> some View {
  ...
  @ViewBuilder
  fileprivate func macOSChannelCommands(
  ...
  @ViewBuilder
  fileprivate func macOSPlayerWindow() -> some View {
    #if os(macOS)
